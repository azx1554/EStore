package com.yang.background.sys.entity;

import com.yang.background.common.persistence.BaseDataEntity;

/**
 * Created by Yang on 2017/10/28 0028.
 */
public class SysUser extends BaseDataEntity<SysUser> {
    private static final long serialVersionUID = 7818472687884783720L;
    private String nick;
